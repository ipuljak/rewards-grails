...
class gsp_rewards_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(2)
expressionOut.print(assetPath(src: 'cupicon.gif'))
printHtmlPart(3)
...
createTagBody(1, {->
printHtmlPart(7)
invokeTag('image','asset',20,['src':("demi_logo.png"),'alt':("Grails")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1492146473000L
